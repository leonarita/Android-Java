...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvResults.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int nrOfTime = Integer.parseInt(etNrTimes.getText().toString().trim());

                new ProcessDiceInBackground().execute(nrOfTime);
            }
        });
    }
    ...
    public class ProcessDiceInBackground extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... integers) {
            ...
            double currentProgress = 0, previosProgress = 0;

            for (int i=0; i<integers[0]; i++) {

                currentProgress = (double) i / integers[0];

                if (currentProgress - previosProgress >= 0.02) {
                    publishProgress(i);
